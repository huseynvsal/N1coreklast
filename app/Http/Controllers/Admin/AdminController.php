...
class AdminController extends Controller
{
    ...
    public function delete_product(Request $request)
    {
        ...
        $image_path = app_path("../public/images/{$product->image1}");
        unlink($image_path);
        $image_path2 = app_path("../public/images/{$product->image2}");
        unlink($image_path2);
        $image_path3 = app_path("../public/images/{$product->image3}");
        unlink($image_path3);
        $image_path4 = app_path("../public/images/{$product->image4}");
        unlink($image_path4);
        $product->delete();
        return response()->json([
            'status' => true,
    ...
    public function delete_partner(Request $request){
        ...
        $image_path = app_path("../public/img/{$partner->image}");
        unlink($image_path);
        $partner->delete();
        return response()->json([
            'status' =>true,
    ...
    public function edit_images(Request $request){
        ...
        if ($request->hasfile('image1')){
            $image_path1 = app_path("../public/images/{$edit->image1}");
            unlink($image_path1);
        ...
        if ($request->hasfile('image3')){
            $image_path3 = app_path("../public/images/{$edit->image3}");
            unlink($image_path3);
        ...
        if ($request->hasfile('image4')){
            $image_path4 = app_path("../public/images/{$edit->image4}");
            unlink($image_path4);
    ...
    public function delete_message(Request $request)
    {
        ...
        if ($message->image != ''){
            $image_path = app_path("../public/msg_images/{$message->image}");
            unlink($image_path);
        }
        $message->delete();
        return response()->json([
